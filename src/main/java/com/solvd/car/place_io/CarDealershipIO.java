...
public class CarDealershipIO extends VehiclePlaceIO<CarDealership<Vehicle>> implements FileOperation<CarDealership<Vehicle>> {
    public static final String CAR_DEALERSHIP_FILE_PATH = "src"
            + FileHelper.SEPARATOR + "main"
            + FileHelper.SEPARATOR + "resources"
            + FileHelper.SEPARATOR + "data"
            + FileHelper.SEPARATOR + "text"
            + FileHelper.SEPARATOR + "car_dealership.txt";
    public static final String CAR_DEALERSHIP_JSON_FILE_PATH = "src"
            + FileHelper.SEPARATOR + "main"
            + FileHelper.SEPARATOR + "resources"
            + FileHelper.SEPARATOR + "data"
            + FileHelper.SEPARATOR + "json"
            + FileHelper.SEPARATOR + "car_dealership.json";
    ...
    @Override
    public CarDealership<Vehicle> readJsonFile(String filePath) {
        CarDealershipPOJO carDealershipPOJO = JsonConverter.convertJsonFileToCarDealershipPOJO(filePath);
        CarDealership<Vehicle> carDealership = new CarDealership<>();
        for (CarPOJO carPOJO: carDealershipPOJO.getSellingCars()) {
            Vehicle vehicle;
